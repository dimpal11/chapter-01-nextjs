            ...
            <div className='container max-w-screen-xl py-0 md:py-5 relative px-0 md:px-4 mx-auto overflow-x-hidden'>
                <div className=" grid grid-cols-1 md:grid-cols-2 ">
                  ...
                  to hear from you!
                    ...
                    <div className="bg-white p-6 md:p-6 lg:p-8 rounded-[10px] shadow-lg border border-[#C4EDD7] ml-auto">
  <form className="space-y-4">
    <input 
      type="text" 
      placeholder="Full Name" 
      className="w-full p-3 md:p-3 lg:p-4 outfit text-xs md:text-sm font-medium text-[#333333] bg-[#ECF4F1] border border-[#C4EDD7] focus:border-[#105F62] focus:outline-none" 
    />
    ...
    <textarea 
      ...
      className="w-full p-3 md:p-3 lg:p-4 outfit text-xs md:text-sm font-medium text-[#333333] bg-[#ECF4F1] border border-[#C4EDD7] focus:border-[#105F62] focus:outline-none h-[80px] md:h-[100px] lg:h-[120px]"
    ></textarea>
    <div className="flex flex-col md:flex-row gap-4 pt-4">
      <button 
        type="reset" 
        className="bg-[#105F62] p-3 md:p-3 lg:p-2 h-[40px] w-full md:w-1/2 uppercase text-white outfit text-sm md:text-base font-semibold"
      >
        Clear
      </button>
      <button 
        type="submit" 
        className="bg-[#105F62] text-white p-3 md:p-3 lg:p-2 h-[40px] w-full md:w-1/2 uppercase outfit text-sm md:text-base font-semibold"
      >
        Submit
      </button>
    </div>
